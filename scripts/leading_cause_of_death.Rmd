...
write.csv(death_count_by_cause, "death_count_by_cause.csv", row.names = FALSE)
```

```{r}
# create table showing top 4 leading causes of death by race
...
knitr::kable(table_top_causes_by_race, caption = "Top 4 Leading Causes of Death by Race")
...
gg <- ggplot(top_causes_by_race, aes(x = Leading.Cause, y = Total_Deaths)) +
  ...
  labs(x = "Top 4 Causes of Death", y = "Total Deaths") 
