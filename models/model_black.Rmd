...
loo_neg_binom_black <- loo(neg_binom_model)
loo_poisson_black <- loo(poisson_model)
loo_comparison_black <- loo_compare(loo_neg_binom_black, loo_poisson_black)
print(loo_comparison_black)
```

```{r}
# Posterior Predictive Checks
# Posterior predictive check for the Negative Binomial model
pp_check_neg_binom_black <-
  pp_check(neg_binom_model)  + ggtitle("Negative Binomial Model")
ggsave(
  "../data/analysis_data/Model_Output/pp_check_neg_binom_black.png",
  plot = pp_check_neg_binom_black,
  width = 10,
  height = 8
)
pp_check_neg_binom_black
...
pp_check_poisson_black <-
  pp_check(poisson_model)  + ggtitle("Poisson Model")
ggsave(
  "../data/analysis_data/Model_Output/pp_check_poisson_black.png",
  plot = pp_check_poisson_black,
  width = 10,
  height = 8
)
pp_check_poisson_black
