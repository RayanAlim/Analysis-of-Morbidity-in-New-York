...
loo_neg_binom_white <- loo(neg_binom_model)
loo_poisson_white <- loo(poisson_model)
loo_comparison_white <- loo_compare(loo_neg_binom_white, loo_poisson_white)
print(loo_comparison_white)
```

```{r}
# Posterior Predictive Checks
# Posterior predictive check for the Negative Binomial model
pp_check_neg_binom_white <-
  pp_check(neg_binom_model)  + ggtitle("Negative Binomial Model")
ggsave(
  "../data/analysis_data/Model_Output/pp_check_neg_binom_white.png",
  plot = pp_check_neg_binom_white,
  width = 10,
  height = 8
)
pp_check_neg_binom_white
...
pp_check_poisson_white <-
  pp_check(poisson_model)  + ggtitle("Poisson Model")
ggsave(
  "../data/analysis_data/Model_Output/pp_check_poisson_white.png",
  plot = pp_check_poisson_white,
  width = 10,
  height = 8
)
pp_check_poisson_white
