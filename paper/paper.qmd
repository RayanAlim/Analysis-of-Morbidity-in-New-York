...
date: today
date-format: long
abstract: "Using Morbidity data for New York City, we analyzed the leading causes of death in New York City, segmented by sex and ethnicity, from 2007 to 2014. Utilizing data derived from NYC death certificates, our research offers insights into public health trends and the importance of understanding how these causes of death vary across races. We foud that while some causes of death are consistent across ethnicities, there are significant variations which suggest ethnicity and socioeconomic factors play a crucial role in mortality. Lastly, we found that causes of death follow a negative binomial distribution acorss different ethnic groups."
format: pdf
